...
namespace EzySlice
{
    ...
    public static class SlicerExtensions
    {
        ...
        {
            //Debug.Log(obj + " " + position + " " + direction + " " + new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f) + " " + crossSectionMaterial);
            Debug.Log(Slice(obj, position, direction, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), crossSectionMaterial));
